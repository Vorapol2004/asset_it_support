...
public class EmployeeService {
    ...
    public List<EmployeeView> ChooseEmployeeRoles(Integer EmployeeRoleId) {
    ...
    public List<EmployeeView> ChooseEmployeeDepartments(Integer EmployeeDepartmentId) {
    ...
    public List<EmployeeView> ChooseEmployeeDepartmentAndRole(Integer EmployeeDepartmentId, Integer EmployeeRoleId) {
    ...
    public List<EmployeeView> searchEmployeeKeyword(String keyword) {
